...
func main() {
	...
	bandSwAConfig := genpage.Config{
		Layout: []genpage.Btn{
			{Type: genpage.Label, Text: "STCK", Position: 4, NextPage: &stackSelectorPage},
			{Type: genpage.Label, Text: "A", Position: 9, NextPage: &bandSwBPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "A", TerminalName: "160m", Text: "160m", Position: 8, NextPage: &stack160mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "A", TerminalName: "80m", Text: "80m", Position: 7, NextPage: &stack80mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "A", TerminalName: "40m", Text: "40m", Position: 6, NextPage: &stack40mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "A", TerminalName: "20m", Text: "20m", Position: 5, NextPage: &stack20mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "A", TerminalName: "15m", Text: "15m", Position: 13, NextPage: &stack15mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "A", TerminalName: "10m", Text: "10m", Position: 12, NextPage: &stack10mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "A", TerminalName: "6m", Text: "6m", Position: 11},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "A", TerminalName: "WARC", Text: "WARC", Position: 10},
		},
	}
	...
	bandSwBConfig := genpage.Config{
		Layout: []genpage.Btn{
			{Type: genpage.Label, Text: "STCK", Position: 4, NextPage: &stackSelectorPage},
			{Type: genpage.Label, Text: "B", Position: 9, NextPage: &bandSwAPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "B", TerminalName: "160m", Text: "160m", Position: 8, NextPage: &stack160mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "B", TerminalName: "80m", Text: "80m", Position: 7, NextPage: &stack80mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "B", TerminalName: "40m", Text: "40m", Position: 6, NextPage: &stack40mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "B", TerminalName: "20m", Text: "20m", Position: 5, NextPage: &stack20mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "B", TerminalName: "15m", Text: "15m", Position: 13, NextPage: &stack15mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "B", TerminalName: "10m", Text: "10m", Position: 12, NextPage: &stack10mPage},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "B", TerminalName: "6m", Text: "6m", Position: 11},
			{Type: genpage.Terminal, DeviceName: "Bandswitch", PortName: "B", TerminalName: "WARC", Text: "WARC", Position: 10},
		},
	}

	stackSelectorConfig := genpage.Config{
		Layout: []genpage.Btn{
			{Type: genpage.Label, Text: "BAND", NextPage: &bandSwAPage, Position: 4},
			{Type: genpage.Label, Text: "160m", NextPage: &stack160mPage, Position: 8},
			{Type: genpage.Label, Text: "80m", NextPage: &stack80mPage, Position: 7},
			{Type: genpage.Label, Text: "40m", NextPage: &stack40mPage, Position: 6},
			{Type: genpage.Label, Text: "20m", NextPage: &stack20mPage, Position: 5},
			{Type: genpage.Label, Text: "15m", NextPage: &stack15mPage, Position: 13},
			{Type: genpage.Label, Text: "10m", NextPage: &stack10mPage, Position: 12},
			{Type: genpage.Label, Text: "N/A", Position: 11},
			{Type: genpage.Label, Text: "N/A", Position: 10},
		},
	}
	...
	sm10mConfig := genpage.Config{
		Layout: []genpage.Btn{
			{Type: genpage.Label, Text: "BAND", NextPage: &bandSwAPage, Position: 4},
			{Type: genpage.Label, Text: "TWR4", Position: 0},
			{Type: genpage.Label, Text: "TWR3", Position: 1},
			{Type: genpage.Label, Text: "TWR2", Position: 2},
			{Type: genpage.Label, Text: "TWR1", Position: 3},
			{Type: genpage.Rotator, DeviceName: "Tower4", Position: 5},
	...
	sm20mConfig := genpage.Config{
		Layout: []genpage.Btn{
			...
			{Type: genpage.Rotator, DeviceName: "Tower2", Position: 7},
			{Type: genpage.Rotator, DeviceName: "Tower1", Position: 8},
			{Type: genpage.Terminal, DeviceName: "Stackmatch 20m", PortName: "SM", TerminalName: "OB11-TWR3", Text: "OB11", Position: 11},
			{Type: genpage.Terminal, DeviceName: "Stackmatch 20m", PortName: "SM", TerminalName: "OB11-TWR2", Text: "OB11", Position: 12},
			{Type: genpage.Terminal, DeviceName: "Stackmatch 20m", PortName: "SM", TerminalName: "OB11-TWR1", Text: "OB11", Position: 13},
		},
	}
	...
	sm40mConfig := genpage.Config{
		Layout: []genpage.Btn{
			...
			{Type: genpage.Rotator, DeviceName: "Tower2", Position: 7},
			{Type: genpage.Rotator, DeviceName: "Tower1", Position: 8},
			{Type: genpage.Terminal, DeviceName: "Stackmatch 40m", PortName: "SM", TerminalName: "DIPOL-TWR3", Text: "DIPL", Position: 11},
			{Type: genpage.Terminal, DeviceName: "Stackmatch 40m", PortName: "SM", TerminalName: "2L-TWR1", Text: "2L", Position: 13},
		},
	}
	...
	sm160mConfig := genpage.Config{
		Layout: []genpage.Btn{
			...
			{Type: genpage.Rotator, DeviceName: "Tower2", Position: 7},
			{Type: genpage.Rotator, DeviceName: "Tower1", Position: 8},
			{Type: genpage.Terminal, DeviceName: "Stackmatch 160m", PortName: "SM", TerminalName: "VERTICAL", Text: "VERT", Position: 11},
			{Type: genpage.Terminal, DeviceName: "Stackmatch 160m", PortName: "SM", TerminalName: "DIPOL", Text: "DIPL", Position: 13},
		},
	}
